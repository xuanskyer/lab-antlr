...
func calclexerLexerInit() {
	...
	staticData.symbolicNames = []string{
		"", "MUL", "DIV", "ADD", "SUB", "NUMBER", "LEFT", "RIGHT", "WHITESPACE",
	}
	...
	staticData.serializedATN = []int32{
		...
		2, 1, 2, 1, 3, 1, 3, 1, 4, 4, 4, 27, 8, 4, 11, 4, 12, 4, 28, 1, 5, 1, 5,
		...
		5, 21, 1, 0, 0, 0, 7, 23, 1, 0, 0, 0, 9, 26, 1, 0, 0, 0, 11, 30, 1, 0,
		0, 0, 13, 32, 1, 0, 0, 0, 15, 35, 1, 0, 0, 0, 17, 18, 5, 42, 0, 0, 18,
		2, 1, 0, 0, 0, 19, 20, 5, 47, 0, 0, 20, 4, 1, 0, 0, 0, 21, 22, 5, 43, 0,
		0, 22, 6, 1, 0, 0, 0, 23, 24, 5, 45, 0, 0, 24, 8, 1, 0, 0, 0, 25, 27, 7,
		0, 0, 0, 26, 25, 1, 0, 0, 0, 27, 28, 1, 0, 0, 0, 28, 26, 1, 0, 0, 0, 28,
		29, 1, 0, 0, 0, 29, 10, 1, 0, 0, 0, 30, 31, 5, 40, 0, 0, 31, 12, 1, 0,
		0, 0, 32, 33, 5, 41, 0, 0, 33, 14, 1, 0, 0, 0, 34, 36, 7, 1, 0, 0, 35,
		34, 1, 0, 0, 0, 36, 37, 1, 0, 0, 0, 37, 35, 1, 0, 0, 0, 37, 38, 1, 0, 0,
		0, 38, 39, 1, 0, 0, 0, 39, 40, 6, 7, 0, 0, 40, 16, 1, 0, 0, 0, 3, 0, 28,
		37, 1, 6, 0, 0,
	}
